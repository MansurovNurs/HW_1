...
class Boss(GameEntity):
    ...
    def __str__(self):
        return 'BOSS' + super().__str__() + ' defence: ' + str(self.defence)
...
class Warrior(Hero):
    ...
    def apply_super_power(self, boss:Boss, heroes: list):
        pass
    #TODO Here will be implamentation of critical amage
...
def start_game():
    ...
    doc = Medic('James', 250, 15, 10)
    assistent = Medic('Marty', 300, 5, 5)
    berserk = Berserk('William', 260, 10)

    heroes_list = [warrior_1, doc, warrior_2, magic, berserk, assistent]
